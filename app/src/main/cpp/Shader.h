...
public:
    ...
    static Shader *loadShader(
            ...
            const std::string &isCircleUniformName);
    ...
    /*!
     * Sets the color tint in the shader.
     * @param color four floats (RGBA).
     */
    void setColor(float r, float g, float b, float a) const;

    /*!
     * Sets whether the current draw call should be a circle.
     */
    void setIsCircle(bool isCircle) const;
